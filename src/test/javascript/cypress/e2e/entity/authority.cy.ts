...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'b0fc6e39-fe54-49c6-9b87-cbcb52566824' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('41d8e857-19f5-4147-811c-160fecd6cbbf');
      cy.get(`[data-cy="name"]`).should('have.value', '41d8e857-19f5-4147-811c-160fecd6cbbf');
